...
const ProfileScreen = () => {
  const { profileAvatar, profileData, updateProfileData, isDarkMode } = useContext(AppContext);
      ...
      <ScrollView style={styles.container} contentContainerStyle={{paddingBottom: 40}} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
            ...
            <View style={[styles.infoCard, {backgroundColor: theme.card}]}>
                <InfoRow icon="business-outline" label="Trường" value={profileData.school} color="#4A90E2" theme={theme} />
                <View style={[styles.divider, {backgroundColor: theme.border}]} />
                <InfoRow icon="book-outline" label="Khoa" value={profileData.major} color="#E67E22" theme={theme} />
                <View style={[styles.divider, {backgroundColor: theme.border}]} />
                <InfoRow icon="person-circle-outlibe" label="Cố vấn" value={profileData.teacher} color="#2ECC71" theme={theme} />
            </View>
        </View>
        ...
        <View style={styles.section}>
            ...
            <View style={styles.grid}>
                {gridData.map(item => (
                    <TouchableOpacity key={item.id} style={[styles.gridItem, {backgroundColor: theme.card}]}>
...
const InfoRow = ({ icon, label, value, color, theme }) => (
    <View style={styles.infoRow}>
        <View style={[styles.rowIcon, {backgroundColor: color + '15'}]}><Ionicons name={icon} size={20} color={color} /></View>
